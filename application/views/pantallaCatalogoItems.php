        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">  
                        ...
                        <a href="<?=asset_url()?>index.php/catalogo/altaItem?id=<?php echo utf8_decode($valor->id) ?>"><button class="btn btn-primary btn-sm " type="button"><i class="fa fa-plus"></i>&nbsp;Nuevo Elemento</button></a>
                        <?php  } ?>
                </div>
