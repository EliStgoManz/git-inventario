...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    <h2>    Inventario de Señales por Tramo</h2>
                    <ol class="breadcrumb">
                        <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>    Numero de Señales por Tramo</strong>
                        </li>
                    </ol>
                    </ol>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" colspan="1">Localización</th>
                                <th class="text-center" colspan="3">Ubicación</th>
                            </tr>
                            <tr>
                                <th>Latitud</th>
                                <th>Longitud</th>
                                ...
                                <th>Lado Der.</th>
                                <th>Ambos</th>
                                <th>Numero de Señales observadas en la foto</th>
                                <th></th>
                            </tr>   
                        </thead>
                        <tbody>
...
function eliminar(id) {
            swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            window.location.replace("<?=asset_url()?>dispositivoSeguridad/eliminarSN?id="+id);
                        } else {
